...
EOF
echo -e "\n\n\n"
echo -e "https://drive.google.com/file/d/1wZOKzRix4edICuLQqaynDc5KD1G2L40M/view?usp=sharing"
echo -e "Access the link to download the Windows client WireGuard."
